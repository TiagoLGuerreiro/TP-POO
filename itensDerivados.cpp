...
CaixaPandora::CaixaPandora(int randomPos, int tempoRestante) : Item(randomPos, tempoRestante){}
...
ArcaTesouro::ArcaTesouro(int randomPos, int tempoRestante) : Item(randomPos, tempoRestante){}

void ArcaTesouro::efeito(Caravana& caravana, Jogador& jogador) {
    cout << "Arca do Tesouro encontrada! 10% mais moedas.\n";
    jogador.setMoedas(jogador.getMoedas() * 0.1);
}

Jaula::Jaula(int randomPos, int tempoRestante) : Item(randomPos, tempoRestante) {}
...
Mina::Mina(int randomPos, int tempoRestante) : Item(randomPos, tempoRestante) {}
...
Surpresa::Surpresa(int randomPos, int tempoRestante) : Item(randomPos, tempoRestante) {}
